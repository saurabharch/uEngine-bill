...
public class SalesRestController {
    ...
    public ResponseEntity<Map> getAccountBalance(HttpServletRequest request,
        ...
        try {
            ...
            Map perDateSummary = salesService.getAccountSalesBalance(role.getOrganization().getId(), id);
    ...
    public ResponseEntity<Map> getAccountSummary(HttpServletRequest request,
        ...
        try {
            ...
            filter.setRequesterType(SalesSummaryType.VENDOR);
            ...
            Map perDateSummary = salesService.getPerDateSummary(role.getOrganization().getId(), filter);
            if (perDateSummary == null) {
                return new ResponseEntity<>(HttpStatus.NOT_FOUND);
            }
    ...
    public ResponseEntity<List<ProductDistributionHistory>> getAccountSales(HttpServletRequest request,
        ...
        try {
            ...
            Map map = salesService.getAccountSalesByCondition(role.getOrganization().getId(), id, null, offset, limit);
    ...
    public ResponseEntity<List<ProductDistributionHistory>> getAccountSalesSearch(HttpServletRequest request,
        ...
        try {
            ...
            Map map = salesService.getAccountSalesByCondition(role.getOrganization().getId(), id, searchKey, offset, limit);
            List<ProductDistributionHistory> historyList = (List<ProductDistributionHistory>) map.get("list");
            if (historyList == null) {
                return new ResponseEntity<>(HttpStatus.NO_CONTENT);
            }
    ...
    public ResponseEntity<ProductDistributionHistory> withdraw(HttpServletRequest request,
        ...
        try {
            ...
            ProductDistributionHistory history = salesService.withdrawAccountBalance(role.getOrganization().getId(), id, withdrawRequest);
    ...
    public ResponseEntity<Void> cancelWithdraw(HttpServletRequest request,
        ...
        try {
            ...
            ProductDistributionHistory history = salesService.selectById(role.getOrganization().getId(), sales_record_id);
            ...
            salesService.cancelWithdraw(role.getOrganization().getId(), sales_record_id);
    ...
    public ResponseEntity<ProductDistributionHistory> updateNotes(HttpServletRequest request,
        ...
        try {
            ...
            ProductDistributionHistory updated = salesService.updateNote(role.getOrganization().getId(), sales_record_id, params.get("notes").toString());
