...
public interface BillingRuleRepository {
    ...
    String NAMESPACE = BillingRuleRepository.class.getName();

    BillingRule selectRuleByOrgId(String organization_id);

    BillingRule insertRule(BillingRule rule);

    BillingRule updateRule(BillingRule rule);
