...
<div class="middle-box text-center loginscreen animated fadeInDown">
    <div>
        ...
        <p data-i18n="auth.login.description">uEngine Billing is a powerful subscription management software which
            handles recurring billing and payments
            efficiently.Sign up for a free test account.
        </p>

        <div class="alert alert-danger" data-i18n="auth.login.retry">
