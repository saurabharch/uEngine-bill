...
-Dorg.killbill.dao.url=jdbc:mysql://$DB_HOST:$DB_PORT/$DB_DATABASE
-Dorg.killbill.dao.user=$DB_USER
-Dorg.killbill.dao.password=$DB_PASSWORD
-Dorg.killbill.billing.osgi.dao.url=jdbc:mysql://$DB_HOST:$DB_PORT/$DB_DATABASE
...
-Dorg.killbill.mail.smtp.user=sppark@uengine.org
-Dorg.killbill.mail.smtp.password=!gosu23546
-Dorg.killbill.mail.from=sppark@uengine.org
-Dorg.killbill.mail.fromname=sppark
-Dorg.killbill.mail.useSSL=true
-Dorg.killbill.mail.redirect.address=http://localhost:8080
-Dorg.killbill.invoice.emailNotificationsEnabled=true
-Dorg.killbill.invoice.globalLock.retries=200
-Dkillbill.url=http://localhost:8080/killbill
-Dkillbill.user=admin
-Dkillbill.password=password
-Diam.trust.client.key=$IAM_CLIENT_KEY
...
#    JAVA_OPTS="$JAVA_OPTS -javaagent:$AGENT_PATH/pinpoint-bootstrap-1.7.1.jar"
#    JAVA_OPTS="$JAVA_OPTS -Dpinpoint.agentId=${MESOS_CONTAINER_NAME##*-}"
#    JAVA_OPTS="$JAVA_OPTS -Dpinpoint.applicationName=$APP_NAME-$PROFILE"
#fi
